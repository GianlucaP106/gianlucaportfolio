...
export const logos = [
    ...
    {
        src: "/assets/logos/2560px-Spring_Framework_Logo_2018.svg.png",
        alt: "Spring Framework",
        w: 120,
        h: 30,
        description: "Spring Framework is a favourite tool in the java ecosystem to build and secure applications"
    },
    {
