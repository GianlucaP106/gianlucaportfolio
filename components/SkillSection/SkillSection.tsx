...
const skills: SkillCardProps[] = [
    ...
    },
    {
        ...
        skills: ["Github", "Git", "Microsoft Azure", "Firebase", "Google Cloud", "Docker", "VSCode", "IntelliJ", "NeoVim", "MacOS", "Linux", "PostgrSQL", "MySQL", "MongoDB", "Github Actions"] //, "Kubernetes fundamentals"]
    },
    {
